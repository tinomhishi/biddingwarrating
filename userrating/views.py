...
def purchase_detail(request, pk):
	...
	edit_form = UserReviewForm(instance=review)
	...
	return render(request, 'userrating/purchase_detail.html', {'purchase': purchase, 'form': form, 'show': show, 'review': review, 'edit_form': edit_form})


@login_required
def sale_detail(request, pk):
	sale = ItemSale.objects.get(pk=pk)
	start_date = sale.created
	deadline =  start_date + timedelta(days=31)
	...
	return render(request, 'userrating/sale_detail.html', {'sale': sale, 'form': form, 'show': show, 'review': review, 'edit_form': edit_form})	
